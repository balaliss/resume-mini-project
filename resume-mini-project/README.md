...
```bash
resume-mini-project$ sam build --use-container
```
...
```bash
resume-mini-project$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
resume-mini-project$ sam logs -n HelloWorldFunction --stack-name resume-mini-project --tail
```
...
```bash
resume-mini-project$ pip install -r tests/requirements.txt --user
# unit test
resume-mini-project$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
resume-mini-project$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name resume-mini-project
```
